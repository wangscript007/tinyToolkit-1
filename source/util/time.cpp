...
namespace tinyToolkit
{
	namespace util
	{
		 ...
		 *
		 */
		int64_t Time::Hour(const std::chrono::system_clock::time_point & point)
		{
		 ...
		 *
		 */
		int64_t Time::Minute(const std::chrono::system_clock::time_point & point)
		{
		 ...
		 *
		 */
		int64_t Time::Second(const std::chrono::system_clock::time_point & point)
		{
		 ...
		 *
		 */
		int64_t Time::Expiration(int64_t day, int32_t hour, int32_t minute, int32_t second)
		{
			if (hour < 0 || hour > 23)
			{
		 ...
		 *
		 */
		int64_t Time::Nanosecond(const std::chrono::system_clock::time_point & point)
		{
		 ...
		 *
		 */
		int64_t Time::Microsecond(const std::chrono::system_clock::time_point & point)
		{
		 ...
		 *
		 */
		int64_t Time::Millisecond(const std::chrono::system_clock::time_point & point)
		{
		 ...
		 *
		 */
		int64_t Time::FromTimeString(const char * date, const char * format)
		{
		 ...
		 *
		 */
		std::string Time::ToTimeString(int64_t second, int64_t timezone, const char * format)
		{
			if (format == nullptr)
			{
				return std::string{ };
		...
		{
			return ToTimeString(Second(), 0, format);
		}
		...
		{
			return ToTimeString(Second(), Timezone(), format);
		}
