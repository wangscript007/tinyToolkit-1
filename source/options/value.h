#ifndef __OPTIONS__VALUE__H__
#define __OPTIONS__VALUE__H__
...
namespace tinyToolkit
{
	namespace options
	{
		...
		public:
			 ...
			 *
			 */
			explicit ActualValue(ValueType && value) : _value(std::forward<ValueType>(value)),
														_default(std::forward<ValueType>(_value.Get<ValueType>())),
