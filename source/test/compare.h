	...
	namespace test
	{
		...
		public:
			...
			static Result Equal(ActualType && actualValue, ExpectedType && expectedValue, const char * actualExpression, const char * expectedExpression)
			{
				...
				return Result(false) << "Value of: " << actualExpression << TOOLKIT_LINE_EOL
...
#define TOOLKIT_TEST_BODY_(function)																						\
...
#define TOOLKIT_TEST_EQ_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::Equal(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_TEST_NE_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::Unequal(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_TEST_LT_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::LessThan(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_TEST_LE_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::LessThanOrEqual(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_TEST_GT_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::GreaterThan(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_TEST_GE_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::GreaterThanOrEqual(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_TEST_BOOLEAN_(condition, expression, actual, expected) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::Boolean(condition, expression, #actual, #expected))

#define TOOLKIT_EXPECT_STR_EQ_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::StringEqual(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_EXPECT_STR_NE_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::StringUnequal(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_EXPECT_STR_CASE_EQ_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::StringCaseEqual(actualValue, expectedValue, actualExpression, expectedExpression))

#define TOOLKIT_EXPECT_STR_CASE_NE_(actualValue, expectedValue, actualExpression, expectedExpression) \
	TOOLKIT_TEST_BODY_(tinyToolkit::test::Compare::StringCaseUnequal(actualValue, expectedValue, actualExpression, expectedExpression))
...
#define TOOLKIT_EXPECT_STR_EQ(actual, expected) \
	TOOLKIT_EXPECT_STR_EQ_(actual, expected, #actual, #expected)

#define TOOLKIT_EXPECT_STR_NE(actual, expected) \
	TOOLKIT_EXPECT_STR_NE_(actual, expected, #actual, #expected)

#define TOOLKIT_EXPECT_STR_CASE_EQ(actual, expected) \
	TOOLKIT_EXPECT_STR_CASE_EQ_(actual, expected, #actual, #expected)

#define TOOLKIT_EXPECT_STR_CASE_NE(actual, expected) \
	TOOLKIT_EXPECT_STR_CASE_NE_(actual, expected, #actual, #expected)
