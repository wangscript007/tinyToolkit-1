...
#define TOOLKIT_PLATFORM_MIPS       1
#define TOOLKIT_PLATFORM_APPLE		2
#define TOOLKIT_PLATFORM_LINUX		3
#define TOOLKIT_PLATFORM_WINDOWS	4


#if defined( __mips64 ) || defined( __mips64__ ) || defined( __MIPS64__ )
#
#  define TOOLKIT_PLATFORM_BYTE 64
#
#  define TOOLKIT_PLATFORM_TYPE TOOLKIT_PLATFORM_MIPS
#
